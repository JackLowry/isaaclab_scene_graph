...
class FrankaSwipeGrabEnv(DirectRLEnv):
    ...
    def _setup_scene(self):
        ...
        self.scene.objects = {obj_cfg.name:RigidObject(obj_cfg) for obj_cfg in self.cfg.objects}
    ...
    def _reset_idx(self, env_ids: torch.Tensor | None):
        ...
        # cabinet state
        zeros = torch.zeros((len(env_ids), self.num_objects, 6), device=self.device)
