...
def main():
    for path in glob("/home/jack/research/scene_graph/isaaclab_scene_graph/assets/GoogleScanOriginal/*"):
        # check valid file path
        mesh_path = path + "/meshes/model.obj"

        # create destination path
        dest_path = f"{path}/object.usd"
